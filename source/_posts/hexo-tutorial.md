...
![hexo文件夹内容](hexo-tutorial/01.png)
...
![文章及其资源文件夹](hexo-tutorial/02.png)
...
![Page Front-matter参数详解](hexo-tutorial/04.png)
...
![Post Front-matter参数详解](hexo-tutorial/05.png)
...
![中文标题文章连接乱码](hexo-tutorial/07.png)

解决方案：

在使用hexo n title 命令新建文章时，title使用英文

![测试英文标题文章链接不乱码](hexo-tutorial/06.png)
